    ...
    <div class="card">
      <div class="card-body">
        <ul class="list-group">
          <li class="list-group-item" v-for="item in items" v-bind:key="item.id">
            <div class="row">
              ...
              <button class="btn btn-warning" v-on:click="deleteItem(item)"><span class="fa fa-trash"></span> </button>
              </div>
            </div>
          </li>
        </ul>
        ...
        <div class="input-group">
          <input class="form-control" type="text" v-model.trim="description" v-on:keyup.enter="addItem(type, description)" placeholder="Digite o sufixo">
